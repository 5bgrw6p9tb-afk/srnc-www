          ...
          <div className="max-w-[1400px] mx-auto px-8 lg:px-12 w-full">
            <AnimatedSection className="max-w-2xl">
              ...
              <h2 className="text-[40px] sm:text-[52px] lg:text-[64px] font-[800] leading-[1.05] tracking-tight text-white mb-8">
                {currentLang === 'pl' ? 'Laczymy dyscypliny naukowe' : currentLang === 'zh' ? '融合科学学科' : 'Bridging Scientific Disciplines'}
              </h2>
              <button className="group px-8 py-4 bg-white text-zinc-950 hover:bg-zinc-100 transition-all rounded-full font-semibold text-[15px] inline-flex items-center justify-center gap-3">
                {t.hero.cta1}
        ...
        <div className="max-w-[1400px] mx-auto px-8 lg:px-12 relative">
          <AnimatedSection className="text-center mb-20">
            ...
            <h2 className="text-[42px] sm:text-[52px] font-[700] leading-[1.1] tracking-tight mb-6">
              {currentLang === 'pl' ? 'Nasze podejscie' : currentLang === 'zh' ? '我们的方法' : 'Our Approach'}
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-12">
            {[
              { label: currentLang === 'pl' ? 'Metodologie' : 'Methodologies', value: 'Eye-tracking, EEG, GSR, EMG', color: '#2E455C' },
              { label: currentLang === 'pl' ? 'Obszary badan' : 'Research Areas', value: 'Attention, Perception, Memory', color: '#DB1500' },
              { label: currentLang === 'pl' ? 'Narzedzia AI' : 'AI Tools', value: 'Data analysis, Modeling', color: '#71717a' }
            ].map((item, i) => (
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-[22px] font-[600] mb-3 leading-tight">
                      {currentLang === 'pl' ? 'Multidyscyplinarne laboratoria dzisiaj' : currentLang === 'zh' ? '今日的多学科实验室' : 'Multidisciplinary Labs Today'}
                    </h3>
      ...
      <section id="cooperation" className="relative py-32 bg-gradient-to-b from-zinc-900/50 to-zinc-950">
        ...
        <div className="max-w-[1400px] mx-auto px-8 lg:px-12">
          ...
          <AnimatedSection delay={400} className="text-center">
            <button className="px-8 py-4 bg-white text-zinc-950 hover:bg-zinc-100 transition-all rounded-full font-semibold text-[15px]">
              {t.cooperation.cta}
            </button>
          </AnimatedSection>
        </div>
